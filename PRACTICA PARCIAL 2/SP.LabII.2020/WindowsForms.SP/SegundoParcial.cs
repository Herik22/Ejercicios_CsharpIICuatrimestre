...
namespace WindowsForms.SP
{
    ...
    public partial class SegundoParcial : Form
    {
        ...
        private void btnVerLog_Click(object sender, EventArgs e)
        {
            ...
            {
                string ruta = openFileDialog1.FileName; //leer el archivo seleccionado por el cliente y mostrarlo en txtVisorTickets
                StreamReader sR = new StreamReader(ruta);
                string lectura = sR.ReadToEnd();
                sR.Close();

                this.txtVisorTickets.Text = lectura;
            }
        }
        ...
        private void btnPunto6_Click(object sender, EventArgs e)
        {
            ...
            this.cn = new SqlConnection(Properties.Settings.Default.conexion_parcialBD);
            //Configurar el SqlDataAdapter (y su selectCommand)                        
            this.ConfigurarDataTabla();
        ...
        private void btnPunto7_Click(object sender, EventArgs e)
        {
            ...
            foreach (Utiles u in this.c_utiles.Elementos)
            {
                ...
                // agrego las filas al data table 
                dt.Rows.Add(file);
            }
        ...
        private void btnPunto8_Click(object sender, EventArgs e)
        {
            ...
            DataRow fila = this.dt.Rows[0]; // ubico el primer registro 
            fila.Delete(); //elimino la fila
        }
        ...
        #region CONFIGURACION DATA TABLE
        /// <summary>
        /// metodo privado que se encarga de configurar el data adapter
        /// </summary>
        /// <returns></returns>
        private void ConfigurarDataTabla()
        {
            this.dt = new DataTable("Utiles");
        ...
        #region CONFIGURACION DATA ADAPTER
